"""REQ_044: Representational Geometry page.
...
Bottom section: centroid PCA snapshot and distance heatmap at a selected
epoch.
"""
...
def create_repr_geometry_layout() -> html.Div:
    ...
    grid = html.Div(
        [
            ...
            dbc.Row(dbc.Col(_graph("rg-timeseries-plot", "1200px"))),
...
def register_repr_geometry_callbacks(app: Dash) -> None:
    ...
    def on_rg_variant_change(
        ...
        return timeseries, pca_fig, dist_fig, slider_max, 0, status
...
def _render_snapshot(
    ...
    """Render centroid PCA and distance heatmap for a single epoch."""
    try:
